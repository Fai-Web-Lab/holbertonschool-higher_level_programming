...
class Rectangle:
    """
    Defines rectangle with instance tracking, comparison, and square creation.

    Attributes:
        number_of_instances (int): Total count of active Rectangle objects.
    ...
    def square(cls, size=0):
        ...
        Returns:
            A new instance of the class (cls).
        """
